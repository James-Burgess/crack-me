...
<body>
  ...
  <p>It only took you {{ count }} attempts, This puts you at Postion: {{ postion }}/{{ total_winners }}</p>
  <p>You took {{ duration }} Hours to get here since {{ sign_up }}</p>
  <p>{{ total_users - total_winners }} are still trying</p>
